...
import com.andremion.floatingnavigationview.sample.MatchActivity;
import com.andremion.floatingnavigationview.sample.MergeActivity;
...
//		imgGridView.setOnItemClickListener(this);
	...
	public void sendfiles(View view){
		...
		if("MergeActivity".equals(className)){
