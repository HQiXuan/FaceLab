...
public class MergeActivity extends AppCompatActivity {
	...
	private ImageView iv_result_merge;
	...
	private android.os.Handler handler = new Handler(){
		...
		public void handleMessage(Message msg) {
			Log.e("handler mergeResult: " , mergeResult);
			byte[] mergePictrue = Base64Util.decode(mergeResult);
			Bitmap bitmap1 = BitmapFactory.decodeByteArray(mergePictrue, 0, mergePictrue.length);
			iv_result_merge.setImageBitmap(bitmap1);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		iv_pictrue1 = findViewById(R.id.iv_pictrue1);
		iv_pictrue2 = findViewById(R.id.iv_pictrue2);
		iv_result_merge = findViewById(R.id.iv_result_merge);
		...
		mFloatingNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
			...
			public boolean onNavigationItemSelected(MenuItem item) {
				...
				if(item.getTitle().equals("人脸评分")){
					intent.setClass(MergeActivity.this, FaceDetectActivity.class);
				}else if (item.getTitle().equals("人脸库添加")){
					intent.setClass(MergeActivity.this, AddPersonActivity.class);
				}else if (item.getTitle().equals("人脸融合")){
					intent.setClass(MergeActivity.this, MergeActivity.class);
				}else if (item.getTitle().equals("人脸识别")){
					intent.setClass(MergeActivity.this, MainActivity.class);
				}else {
					intent.setClass(MergeActivity.this, MatchActivity.class);
				}
	...
	//文件上传的处理
	public void uploadMerge(View view) {
		progressDialog = ProgressDialog.show(MergeActivity.this, "正在融合......", "");
		...
		new Thread() {
			...
			public void run() {
				...
				//String uploadUrl = "http://192.168.31.94:8080/merge";
				String uploadUrl = "http://114.55.65.146:8080/merge";
				//String uploadUrl = "http://172.20.10.2:8080/merge";
				...
				call.enqueue(new Callback() {
					...
					public void onFailure(Call call, IOException e) {
						...
						Toast toast = Toast.makeText(MergeActivity.this, "上传图片失败......", Toast.LENGTH_SHORT);
					...
					public void onResponse(Call call, Response response) throws IOException {
						...
						mergeResult = json;
						//Toast toast = Toast.makeText(MergeActivity.this, "", Toast.LENGTH_SHORT);
						progressDialog.dismiss();
	...
	public void chise(View v){
		...
		bundle.putString("className","MergeActivity");
